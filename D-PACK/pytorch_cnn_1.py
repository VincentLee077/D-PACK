...
#			,[80,2],[80,3],[80,4],[80,5]]
#arg_list = [[40,2],[40,3],[40,4],[40,5]]
#arg_list = [[50,2],[50,3],[50,4],[50,5]]
#arg_list = [[60,2],[60,3],[60,4],[60,5]]
#arg_list = [[70,2],[70,3],[70,4],[70,5]]
#arg_list = [[80,2],[80,3],[80,4]]
#arg_list = [[40,2],[40,3],[40,4],[40,5],[50,2],[50,3],[50,4],[50,5]
#			,[60,2],[60,3],[60,4],[60,5],[70,2],[70,3],[70,4],[70,5]
#			,[80,2],[80,3],[80,4],[80,5]]
#arg_list = [[40,2],[40,3]
...
#		M_Data = []
		...
		M_data = input_Data('data/attack/deep_no_header_packet_structure/', pshape, m_size)
...
#	for i in range(len(DATAS)):
#		print("{}".format("TEST"+str(i)+"\t"),end='')
#		for x,y in DATAS[i].__dict__.items() :
#			if x not in  ['CNN_confm','auto_confm','Benign_all_loss','Benign_loss','Benign_sd']:
##				print(type(y),x)
#				if type(y) is np.float64:
#					print("{:15}".format(format(y,'.6f')),end='')
#				else :
